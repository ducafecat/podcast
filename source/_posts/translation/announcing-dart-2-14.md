...
Dart 团队维护了一个 [Dart 风格指南](https://dart.dev/guides/language/effective-dart/style "https://dart.dev/guides/language/effective-dart/style")，它描述了 Dart 团队认为编写和设计 Dart 代码的最佳方式。
